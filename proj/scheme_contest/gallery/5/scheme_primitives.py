...
import operator
import sys
import random #for contest
import colorsys #for contest
...
#The below are for the contest
@primitive("bgcolor")
def scheme_bgcolor(color):
    turtle.bgcolor(color)

@primitive("pencolor")
def scheme_pencolor(color):
    turtle.pencolor(color)

@primitive("circle")
def scheme_circle(radius):
    turtle.circle(radius)

@primitive("right")
def scheme_right(deg):
    turtle.right(deg)

@primitive("fill")
def scheme_fillcolor(color):
...
@primitive("hsv_rgb")
def scheme_colorsys_hsv_to_rbg(x, y, z):
    return colorsys.hsv_to_rgb(x, y, z)
